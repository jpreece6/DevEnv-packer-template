...
# setup openssh
$ssh_download_url = "http://www.mls-software.com/files/setupssh-7.3p1-1.exe"
...
if (!(Test-Path "C:\Program Files\OpenSSH\bin\ssh.exe")) {
    ...
    Start-Process "C:\Windows\Temp\openssh.exe" "/S /port=2222 /privsep=1 /password=vagrant" -NoNewWindow -Wait
}
